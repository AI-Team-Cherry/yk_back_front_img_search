...
# from .segmentation_model import parse_human_parts
# from .category_model import predict_clothing_category

# router = APIRouter()

# # 경로 설정
# BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
# DATA_DIR = os.path.join(BASE_DIR, "img_search")
# IMG_DIR = os.path.join(DATA_DIR, "only_product_images")
