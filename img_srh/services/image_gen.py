...
async def generate_image(prompt: str, top: int):
    caption_csv = os.path.join(os.path.dirname(__file__), "..", "data", "caption(fashion-clip)_embedding.csv")
    image_csv   = os.path.join(os.path.dirname(__file__), "..", "data", "image_embedding.csv")
